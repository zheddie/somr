...
//	
	//TODO: why need ot use mem_free_memory() here? it would check the footer and header, while it's just a char *, instead of any object.Trying free  it directly
	//omrmem_free_memory((void *)objEntry->name);
	free((void *)objEntry->name);
//	
	objEntry->name = NULL;
